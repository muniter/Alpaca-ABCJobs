...
class InterviewsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_interviews_list, container, false)
        ...
        if (view is RecyclerView) {
            with(view) {
                ...
                adapter = InterviewItemRecyclerViewAdapter(PlaceholderContent.ITEMS)
            }
        }
        return view
    }
